...
public class Part {
    ...
    // ADD THIS FIELD TO THE PART CLASS:
    ...
    public int getMultipackQuantity() { return multipackQuantity; }
    public void setMultipackQuantity(int multipackQuantity) { this.multipackQuantity = multipackQuantity; }

    // ADD GETTER AND SETTER FOR PRODUCTS:
    public Set<Product> getProducts() { return products; }
    public void setProducts(Set<Product> products) { this.products = products; }

    public boolean isMultipack() { return multipackQuantity > 1; }
    public boolean isInventoryValid() { return inv >= minInventory && inv <= maxInventory; }
